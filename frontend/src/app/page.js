"use client";
import { registerPasskey, hello } from "./passkey/register";
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-8 w-full max-w-md">
      ...
      <div>
        ...
        <input type="text" id="login-username" placeholder="Username" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 mb-4" />
        <button onClick="loginPasskey()" className="w-full bg-green-500 text-white font-semibold py-2 rounded-lg hover:bg-green-600 transition duration-300">Login with Passkey</button>
